...
export default function Home() {
	return (
		<>
			<nav className="grid grid-cols-3 pl-6 pr-10 py-4">
				<div>Reaimagine</div>
			...
			<div className="grid grid-cols-2 min-h-screen pr-10 pl-6">
			...
			<div className="flex justify-between pl-6 pr-10 mt-24 my-10">
			...
			<div className="flex relative justify-between pl-6 pr-10 h-[80vh]">
			...
			<div className="pl-7 pr-10 mt-60">
			...
			<div className="mt-40 grid grid-cols-[2fr_3fr] pl-6 pr-10">
				...
				<div className="flex justify-center">
					<Accordion.Root type="single" collapsible className="w-full">
						<Accordion.Item value="item-1" className="w-full">
							<Accordion.Header>
								<Accordion.Trigger className="flex justify-between items-center w-full border-1 border-b border-slate-400 py-5">
			...
			<footer className="grid grid-cols-2 bg-[#144769] h-96 p-10 text-white mt-10">
